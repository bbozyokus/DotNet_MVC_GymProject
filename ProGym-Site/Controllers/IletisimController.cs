...
namespace ProGym_Site.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Tel,Facebook,Twitter,Instagram,Email")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Tel,Facebook,Twitter,Instagram,Email")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
